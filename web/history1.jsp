<%-- 
    Document   : history1
    Created on : Apr 6, 2016, 2:46:46 PM
            ...
            <table>
                <tr >
                    <td width="1200" valign="top">
                        <div id="welcome" style="border-right:#666666 1px dotted;"><h1>HISTORY FORM</h1><br>
                            <table  align="center">
                                <tr>
                                ...
                                <tr>
                                    <td><div><%if (request.getAttribute("balance") != null) {
                                            ...
                                            %></div>
                                        <form name=F1 onSubmit="return dil(this)" action="history.jsp" >
